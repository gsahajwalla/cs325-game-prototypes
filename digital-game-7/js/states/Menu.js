var Menu = {
	...
	create: function() {
		...
		this.text = game.add.text(0, 200, "- 6 per level. If the player collides with the store associates \n in Level 1 the player telleports to a random position\n in Level 2 player telleports to the start", {font: "25px Arial", fill: "#ffffff"});
		...
		this.text = game.add.text(0, 420, "- Maximum of 250 secs to finish the game", {font: "25px Arial", fill: "#ffffff"});
