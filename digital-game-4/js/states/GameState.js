var GameState = {
	...
	setVelocities: function() {
		...
		this.h1.body.velocity.x = this.velocity[0];
		this.h2.body.velocity.x = this.velocity[1];
		this.h3.body.velocity.x = this.velocity[2];
		this.h4.body.velocity.x = this.velocity[3];
	}
};